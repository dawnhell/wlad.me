  ...
  <div className="py-16 border-t border-t-slate-200">
    ...
    <div className="mt-4 mb-8">
      ...
      <p className="mb-2 text-base text-slate-600 font-['Roboto Slab'] tracking-wide italic">
        As a JavaScript/ReactJS developer specializing in TypeScript, NextJS,
        and NX, I craft dynamic web applications with sleek interfaces using
        ChakraUI, TailwindCSS, and Emotion for styling. I ensure code quality
        and reliability through rigorous testing with Jest, RSpec, and VCR. I
        manage version control efficiently with Git submodules, organize
        projects with NPM packages, and maintain scalable codebases with
        Monorepos.
      </p>
