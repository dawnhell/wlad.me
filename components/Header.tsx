...
const Header: FC = () => {
  return (
    <div className="mx-auto flex flex-col items-center gap-4 justify-between mb-10 sm:mb-16 sm:flex-row">
      <a href="https://www.wlad.me" className="text-3xl font-bold">
        <AuroraText speed={4}>WLAD.ME</AuroraText>
      </a>
      ...
      <div className="flex items-center justify-between w-full sm:w-max">
        ...
        <div className="socials flex items-center justify-center gap-2">
          ...
          <Button
            ...
            asChild
          >
            <a href="mailto:wlad@wlad.me" aria-label="Email">
              <Mail />
            </a>
          </Button>
